...
const pdfStyles = {
  ...
  pageWrap: { flex: 1, padding: '28px 40px', overflowY: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', background: '#3a3f4a' },
  page: { width: '100%', maxWidth: 580, background: 'white', padding: '50px 56px', boxShadow: '0 4px 20px rgba(0,0,0,0.4)', fontFamily: 'Georgia, var(--font-display), serif', minHeight: 720, position: 'relative', boxSizing: 'border-box' },
